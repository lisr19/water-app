	...
	<view style="position: relative;" :class="size === 'small' ? 'small' : ''">
		<view class="uni-flex" :class="{unishadow :uniShadow}">
			...
			<view class="uni-action">
				<view @click="handleSearch" style="font-size:28rpx;color:#000000;background-color: #FFFFFF;border-radius: 10rpx;padding:15rpx;display: flex;align-items: center;justify-content: center;">搜索</view>
				<!-- <button 
					class="uni-cu-btn uni-bg-gradual-green uni-round" 
					hover-class="none"
					style=""
					@click="handleSearch"
				>搜索</button> -->
