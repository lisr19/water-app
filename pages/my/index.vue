<template>
	<view>
		...
		<u-cell-group >
			<u-cell-item icon="file-text" icon-size="40" :icon-style="icon_style" title="巡检任务" @click="toPatrol()">
				<u-badge :count="patrol_count" :absolute="false" slot="right-icon"></u-badge>
			</u-cell-item>
			<u-cell-item icon="email" icon-size="40" :icon-style="icon_style" title="消息通知" @click="toMsg()">
				<u-badge :count="msg_count" :absolute="false" slot="right-icon"></u-badge>
			</u-cell-item>
			<u-cell-item icon="question-circle" icon-size="40" :icon-style="icon_style" title="问题处理" @click="toQues()">
				<u-badge :count="report_count" :absolute="false" slot="right-icon"></u-badge>
			</u-cell-item>
			<u-cell-item icon="lock" icon-size="40"  :icon-style="icon_style" title="修改密码" @click="show=true"></u-cell-item>
		</u-cell-group>
		<view class="bottom">
